...
public class _00_Class_09_method {
    public static void main(String[] args) {
        ...
        loop: while (true) {
            ...
            switch (choice) {
                case 1://밀크커피
                    myMoney = order(myMoney,300,"밀크커피");break;
                case 2://헤이커피
                    myMoney = order(myMoney,500,"헤이커피");break;
                case 3://블랙커피 350
                    myMoney = order(myMoney,350,"블랙커피");break;
                case 4://코코아 350
                    myMoney = order(myMoney,350,"코코아");break;
                case 5://우유 400
                    myMoney = order(myMoney,400,"우유");break;
                case 6: // 잔액충전
                    System.out.println("잔액을 충전합니다. 얼마를 충전하시겠습니까?");int temp = scan.nextInt();if (temp > 0) {
                        System.out.println("결제수단 : 1. 카드결제 2. 현금결제");
                        choice = scan.nextInt();
                        if (choice == 1) {
                            myMoney += temp;
                            System.out.println("[ 카드결제가 되었습니다.]");System.out.println("충전 금액 : " + temp);System.out.println("현재 잔액 : " + myMoney);System.out.println();
                        } else {
                            System.out.println(" [ 시스템 오류 다시 실행 요망] ");System.out.println();}}
                    break;
                case 0:
